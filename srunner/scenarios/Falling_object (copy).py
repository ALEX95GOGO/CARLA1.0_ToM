...
class FallingObject(BasicScenario):
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.second_vehicle_distance = 20
    ...
    def _initialize_actors(self, config):
        ...
        object_choices = ["static.prop.box01", "static.prop.colacan"]
        ...
        first_vehicle = CarlaDataProvider.request_new_actor("static.prop.box01", first_vehicle_temp_transform)
