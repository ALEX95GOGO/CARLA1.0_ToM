...
class UncertainObject(BasicScenario):
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.second_vehicle_distance = 18
        ...
        super(UncertainObject, self).__init__("UncertainObject",
                                                    ego_vehicles,
                                                    config,
                                                    world,
                                                    debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        object_choices = ["static.prop.box01"]
        object_model = random.choice(object_choices)

        # Initial transform (above the road, so it drops)
        object_transform = self.wp_first_vehicle.transform

        self.object_blueprint = self.world.get_blueprint_library().find(object_model)
