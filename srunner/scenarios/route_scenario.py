...
from core.utils.simulator_utils.carla_utils import convert_waypoint_to_transform

# # pylint: disable=line-too-long
from core.simulators.srunner.scenarioconfigs.scenario_configuration import ScenarioConfiguration, ActorConfigurationData
# pylint: enable=line-too-long
from core.simulators.carla_data_provider import CarlaDataProvider
from core.simulators.srunner.scenariomanager.scenarioatomics.atomic_behaviors import Idle, ScenarioTriggerer
from core.simulators.srunner.scenarios.basic_scenario import BasicScenario
from core.simulators.srunner.tools.route_parser import RouteParser, TRIGGER_THRESHOLD, TRIGGER_ANGLE_THRESHOLD
...
from core.simulators.srunner.scenarios.cut_in_stationary_object import CuttingInStationaryObject
from core.simulators.srunner.scenarios.cut_in_active_object import CuttingInActiveObject
from core.simulators.srunner.scenarios.occluded_crossing_junction import OccludedCrossingJunction
from core.simulators.srunner.scenarios.occluded_left_crossing_junction import OccludedLeftCrossingJunction
from core.simulators.srunner.scenarios.cyclist_move_right import CyclistMoveRight 
from core.simulators.srunner.scenarios.pedestrian_look_left import PedestrianLookLeft 
from core.simulators.srunner.scenarios.Falling_object import FallingObject 
from core.simulators.srunner.scenarios.uncertain_object import UncertainObject 
from core.simulators.srunner.scenarios.pedestrian_turn_around import CuttingInActiveObject
...
SCENARIO_CLASS_DICT = {
    ...
    "TOM_01": CyclistMoveRight,
    "TOM_02": PedestrianLookLeft,
    "DSTG_01": FallingObject,
    "DSTG_02": UncertainObject
}
...
class RouteScenario(BasicScenario):
    ...
    def _build_scenario_instances(
        ...
        for scenario_number, definition in enumerate(scenario_definitions):
            ...
            scenario_configuration.switch = self.config.switch
