...
from env_car_following import CarFollowing
...
def train_car_following_task():
    ...
    env = CarFollowing(joystick_enabled = args.joystick_enabled, 
    ...
    for i in range(start_epoch, args.maximum_episode):
        ...
        while not done:
            ...
            central_line = get_path(ego_y) # a reference trajectory's central line in x axis
