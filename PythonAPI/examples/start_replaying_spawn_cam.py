...
def main():
    ...
    try:
        ...
        client.replay_file(r"G:\pilot_data\test_gaze\recording\auto_5_-19-10-2023-12-12-44.bin",0,0,0)
        ...
        preset = _weather_presets[_weather_index]
        ...
        while True:
            ...
            #world_snapshot = world.wait_for_tick()
            #sem_cam.listen(lambda image: image.save_to_disk('tutorial/new_rgb_output/%.6d.jpg' % image.frame))
            #time.sleep(1)
            #spectator.set_transform(ego_vehicle.get_transform())
